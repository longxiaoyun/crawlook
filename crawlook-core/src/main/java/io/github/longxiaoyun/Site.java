...
import io.github.longxiaoyun.utils.HttpConstant;
...
//    public Site setMeta(Map<String, Object> meta) {
//        this.meta = meta;
//        return this;
//    }
    public Site setMeta(Meta meta) {
        this.meta = meta;
        return this;
    }
    public Meta getMeta() {
...
//    }
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(charset, site.charset)) {
            return false;
        }
        if (!Objects.equals(defaultCookies, site.defaultCookies)) {
            return false;
        }
        if (!Objects.equals(domain, site.domain)) {
            return false;
        }
        if (!Objects.equals(headers, site.headers)) {
            return false;
        }
        if (!Objects.equals(userAgent, site.userAgent)) {
            return false;
        }
        if (!Objects.equals(meta, site.meta)) {
            return false;
        }
