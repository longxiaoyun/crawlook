...
import io.github.longxiaoyun.selector.Json;
import io.github.longxiaoyun.selector.Selectable;
...
public class Page {
     ...
     * @param bean bean
     */
    public void putModel(Object bean) {
        Objects.requireNonNull(bean, "bean must not be null");
        Field[] fields = getFields(bean);
        for (Field field: fields) {
            field.setAccessible(true);
            try {
                putField(field.getName(), field.get(bean));
    ...
    public Field[] getFields(Object bean) {
